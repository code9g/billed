            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-employee">
                  ...
                  <input id="employee-email-input" type="email" data-testid="employee-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="employee-password-input">Mot de passe</label>
                  <input id="employee-password-input" type="password" data-testid="employee-password-input" class="form-control" placeholder="******" required>
            ...
            <div class="card">
              <div class="card-body">
                <form class="form-signin" data-testid="form-admin">
                  ...
                  <input id="admin-email-input" type="email" data-testid="admin-email-input" class="form-control" placeholder="johndoe@email.com" required autofocus>
                  <label for="admin-password-input">Mot de passe</label>
                  <input id="admin-password-input" type="password" data-testid="admin-password-input" class="form-control" placeholder="******" required>
